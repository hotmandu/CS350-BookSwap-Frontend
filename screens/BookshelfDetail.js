          ...
          <SafeAreaView style={styles.topContainer}>
            ...
            <View style={styles.buttonContainer}>
              <Pressable style={[styles.edit, styles.delete]} onPress={toggleModal}>
                ...
                <Text style={styles.deleteText}>{t('screen.bookDetails.delete')}</Text>
              </Pressable>
              <Pressable style={[styles.edit]} onPress={handleEdit}>
                <MaterialIcons name="edit" size={14} color={colors.White} />
                <Text style={styles.editText}>{t('screen.bookDetails.edit')}</Text>
              </Pressable>
            ...
            >
              <View style={styles.modalOverlay}>
                <CustomConfirmBox
                  confirmMsg={t('screen.bookshelfDetails.delConfirm', {title: DATA.title})}
